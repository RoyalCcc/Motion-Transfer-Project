...
config['gpu_ids'] = [2] #default='-1', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
config['test_gpu_ids'] = [2]

config['train_interval'] = 10
config['phase'] = 'train' #'syn' or 'train'

config['exp_dir'] = 'subject3'
config['syn_exp_dir'] = 'subject3'
...
train_opt['target_names'] = ['subject3']
...
test_opt['target_names'] = ['subject3']
